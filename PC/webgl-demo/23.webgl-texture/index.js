window.onload = () => {
    ...
    const fragmentShaderSource =
        ...
        void main() {
            gl_FragColor = texture2D(u_Sampler, v_TexCoord); // 设置贴图
        }
    `;
    ...
    function initTextures(gl, program, resolve) {
        ...
        image.onload = function () { loadTexture(gl, program, image, resolve) };
        image.src = './1.jpg';
    }
     ...
     * @param {Function} resolve promise resolve function
     */
    function loadTexture(gl, program, image, resolve) {
        // 创建纹理
