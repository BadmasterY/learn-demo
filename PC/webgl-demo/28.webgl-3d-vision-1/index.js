window.onload = () => {
    ...
    const top = 1.0, bottom = -1.0, left = -1.0, right = 1.0;
    let near = 0.0, far = 0.5;

    information.innerText = `near: ${near}, far: ${far}`;
    ...
    const vertexShaderSource =
        ...
        uniform mat4 u_ProjMatrix; // 添加正射投影矩阵

        varying vec4 v_Color;

        void main() {
            gl_Position = u_ProjMatrix * a_Position; // 设置顶点坐标(正射投影矩阵 x 原始坐标)
            v_Color = a_Color;
        }
    `;
