window.onload = () => {
    ...
    function initVertexBUffers(gl, program) {
        ...
        const verticesSizes = new Float32Array([
            0.0, 0.5, 15.0, 1.0, 0.0, 0.0,
            -0.5, -0.5, 20.0, 0.0, 1.0, 0.0,
            0.5, -0.5, 25.0, 0.0, 0.0, 1.0,
        ]);
        ...
        const sizeSize = 1;
        const colorSize = 3;
        const size = positionSize + sizeSize + colorSize;
        ...
        gl.vertexAttribPointer(a_Color, colorSize, gl.FLOAT, false, FSIZE * size, FSIZE * (positionSize + sizeSize));
